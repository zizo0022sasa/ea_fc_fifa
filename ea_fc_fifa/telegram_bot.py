...
# -*- coding: utf-8 -*-
"""
🔥 بوت التليجرام الاحترافي - النسخة النهائية
...
class TelegramBot:
    ...
    async def receive_quantity(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        try:
            ...
            # عرض النتائج
            success_rate = (results["successful"] / accounts_needed * 100) if accounts_needed > 0 else 0
    ...
    async def show_stats(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if order_stats['total_orders'] > 0:
            success_rate = (order_stats['successful'] / order_stats['total_orders']) * 100
...
def main():
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            WAITING_LINK: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot.receive_link)],
            WAITING_QUANTITY: [MessageHandler(filters.TEXT & ~filters.COMMAND, bot.receive_quantity)]
        },
